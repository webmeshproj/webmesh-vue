            ...
            (t.Builder = function () {
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        for (var b = 0; b < d.length; b++) {
                            ...
                            this.invertedIndex[g][o][r] == null &&
                                (this.invertedIndex[g][o][r] =
                                    Object.create(null));
                            for (
                                var m = 0;
                                m < this.metadataWhitelist.length;
                                m++
                            ) {
                ...
                (t.Builder.prototype.calculateAverageFieldLengths =
                    function () {
                        ...
                        for (
                            var l = Object.keys(this._fields), s = 0;
                            s < l.length;
                            s++
                        ) {
                            var u = l[s];
...
`);
        ...
        handleValueChange() {
            (this.el.checked = this.value),
                ...
                document.querySelectorAll('.tsd-index-section').forEach((n) => {
                    ...
                    let r = Array.from(
                        n.querySelectorAll('.tsd-index-link'),
                    ).every((i) => i.offsetParent == null);
    ...
    var Z = class extends C {
        ...
        update() {
            (this.icon.style.transform = `rotate(${
                this.el.open ? 0 : -90
            }deg)`),
    ...
    function Ee(t, e, n) {
        if (t.path) {
            ...
            (r.href = Le + t.path),
                ...
                (r.appendChild(document.createElement('span')).textContent =
                    t.text);
        } else
